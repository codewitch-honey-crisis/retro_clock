...
env.Execute("python clasptree.py ./www -o ./include/httpd_content.h -p httpd_ -E ./include/httpd_epilogue.h -s resp_arg -b httpd_send_block -e httpd_send_expr -H extended")